      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            All-Bright is always in search of excellent writers who are looking for freelance job opportunities. If you want to write from home, we can give you a plenty of writing tasks of various complexity levels and thematic areas, including academic and non-academic topics.
          </Typography>
        </div>
